...
image: mengenal-hermes-agent-langkah-baru-setelah-openclaw.en.png
---
...
1. the user asks,
2. the AI answers,
3. the user does the rest.

With Hermes Agent, the workflow can look more like this:

1. the user gives a goal,
2. the agent understands the context,
3. the agent determines the relevant steps,
4. the agent uses the necessary tools,
5. the result is returned in a usable form.
